...
import type { MatchState as _MatchState, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createGamePurchaseSession(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createGamePurchaseSession(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async findMatch(arg0: boolean): Promise<MatchState | null> {
        if (this.processError) {
            try {
                const result = await this.actor.findMatch(arg0);
    ...
    async getAllRanks(): Promise<Array<Rank>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllRanks();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLeaderboard(arg0: bigint): Promise<Array<[Principal, PlayerStats]>> {
        if (this.processError) {
            try {
    ...
    async getRankForPoints(arg0: bigint): Promise<Rank> {
        if (this.processError) {
            try {
                const result = await this.actor.getRankForPoints(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasPurchasedAccess(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasPurchasedAccess();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async pointsToRankId(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.pointsToRankId(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitResult(arg0: string, arg1: Principal, arg2: Principal, arg3: bigint, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitResult(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async unlockWithPurchase(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.unlockWithPurchase(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MatchState]): MatchState | null {
    return value.length === 0 ? null : value[0];
}
